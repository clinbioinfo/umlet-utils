package Umlet::Python::Module::File::Writer;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new Umlet::Python::Module::File::Writer(@_);

        if (!defined($instance)){

            confess "Could not instantiate Umlet::Python::Module::File::Writer";
        }
    }
    return $instance;
}
...
=head1 NAME
 ...
 Umlet::Python::Module::File::Writer
...
=head1 SYNOPSIS
 ...
 use Umlet::Python::Module::File::Writer;
 my $manager = Umlet::Python::Module::File::Writer::getInstance();
