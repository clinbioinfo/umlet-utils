package Umlet::Python::Class::Singleton::File::Writer;
...
use constant DEFAULT_SINGLETON_CLASS_FILE => "$FindBin::Bin/../template/python_singleton_class_tmpl.tt";
...
has 'class_template_file' => (
    ...
    required => FALSE,
    default  => DEFAULT_SINGLETON_CLASS_FILE
    );
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new Umlet::Python::Class::Singleton::File::Writer(@_);

        if (!defined($instance)){

            confess "Could not instantiate Umlet::Python::Class::Singleton::File::Writer";
        }
    }
    return $instance;
}
...
=head1 NAME
 ...
 Umlet::Python::Class::Singleton::File::Writer
...
=head1 SYNOPSIS
 ...
 my $manager = Umlet::Python::Class::Singleton::File::Writer::getInstance();
