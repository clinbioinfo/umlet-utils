package Umlet::Python::API::SequenceDiagram::Converter;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new Umlet::Python::API::SequenceDiagram::Converter(@_);

        if (!defined($instance)){

            confess "Could not instantiate Umlet::Python::API::SequenceDiagram::Converter";
        }
    }
    return $instance;
}
...
=head1 NAME
 ...
 Umlet::Python::API::SequenceDiagram::Converter
...
=head1 SYNOPSIS
 ...
 use Umlet::Python::API::SequenceDiagram::Converter;
 my $converter = Umlet::Python::API::SequenceDiagram::Converter::getInstance();
