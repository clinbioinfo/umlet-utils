package Umlet::Python::ClassDiagram::File::XML::Parser;
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new Umlet::Python::ClassDiagram::File::XML::Parser(@_);

        if (!defined($instance)){

            confess "Could not instantiate Umlet::Python::ClassDiagram::File::XML::Parser";
        }
    }
    return $instance;
}
...
=head1 NAME
 ...
 Umlet::Python::ClassDiagram::File::XML::Parser
...
=head1 SYNOPSIS
 ...
 my $parser = new Umlet::Python::ClassDiagram::File::XML::Parser(infile => $infile);
